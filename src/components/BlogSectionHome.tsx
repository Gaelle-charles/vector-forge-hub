...
const BlogSectionHome = () => {
  ...
  if (!featuredArticle && (!articles || articles.length === 0)) {
    return <section id="blog" className="py-40 bg-white section-slide-up rounded-t-[4rem] -mt-16 z-30 relative">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center">
  ...
  // L'article featured est déjà défini dans useArticles comme l'article le plus récent
  return <section id="blog" className="py-40 bg-white section-slide-up rounded-t-[4rem] -mt-16 z-30 relative">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="space-y-12">
          {/* Article Principal (Article le plus récent) */}
          {featuredArticle && (
