      ...
      <section id="blog" className="py-40 bg-white section-slide-up rounded-t-[4rem] -mt-16 z-30 relative">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-black from-emerald-700 to-emerald-800 rounded-3xl p-8 relative overflow-hidden stagger-child opacity-0 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 group">
              {/* Decorative Elements */}
              ...
              <div className="bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 group stagger-child opacity-0 overflow-hidden border border-gray-100">
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <Button 
                      variant="ghost"
                      className="text-[#e76f51]-500 hover:text-pink-600 hover:bg-pink-50 p-0 h-auto font-medium text-sm"
                      onClick={() => window.location.href = '/blog'}
                    >
                      Lire l'article
                    </Button>
